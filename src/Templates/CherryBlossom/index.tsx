...
const CherryBlossom = (data: IResInvitation) => {
  ...
  return (
    <S.Container ref={containerRef}>
      ...
      <S.GalleryContainer ref={addItemRef} className="observer">
        <div className="title">
          <img src="/Template/title_gallery.png" className="eng" />
          <img src="/Template/title_flower.png" className="flower" />
        </div>
      ...
      <S.GuestBookContainer ref={addItemRef} className="observer">
        <div className="title">
          <span className="eng">guest book</span>
      ...
      <S.LocationContainer ref={addItemRef} className="observer">
        <div className="title">
          <img src="/Template/title_location.png" className="eng" />
          <img src="/Template/title_flower2.png" className="flower" />
        </div>
      ...
      <S.AccountContainer ref={addItemRef} className="observer">
        <img src="/Template/title_flower3.png" />
        <h2 className="title">
          참석이 어려우신 분들은
          <br />
          축하의 마음을 전해주세요.
      ...
      <S.ContactWrapper ref={addItemRef} className="observer">
        <div className="main">
          <div className="husband">
            <span>신랑 {data.HUSBAND.ME.name}</span>
            <div className="icon">
              <a href={`tel:${data.HUSBAND.ME.contact}`} className="tel">
                <BsTelephoneFill color="#fff" size={20} />
              </a>
              <a href={`sms:${data.HUSBAND.ME.contact}`} className="sms">
                <BsChatText color="#fff" size={20} />
              </a>
            </div>
          </div>
          <div className="wife">
            <span>신부 {data.WIFE.ME.name}</span>
            <div className="icon">
              <a href={`tel:${data.WIFE.ME.contact}`} className="tel">
                <BsTelephoneFill color="#fff" size={20} />
              </a>
              <a href={`sms:${data.WIFE.ME.contact}`} className="sms">
                <BsChatText color="#fff" size={20} />
              </a>
            </div>
          </div>
        ...
        <div className="parent">
          <div className="husband">
            ...
            {data.HUSBAND.FATHER.contact && (
              <div>
                <span>아버지 {data.HUSBAND.FATHER.name}</span>
                <div className="icon">
                  <a href={`tel:${data.HUSBAND.FATHER.contact}`} className="tel">
                    <BsTelephoneFill color="#fff" size={20} />
                  </a>
                  <a href={`sms:${data.HUSBAND.FATHER.contact}`} className="sms">
                    <BsChatText color="#fff" size={20} />
                  </a>
                </div>
              </div>
            ...
            {data.HUSBAND.MOTHER.contact && (
              <div>
                <span>어머니 {data.HUSBAND.MOTHER.name}</span>
                <div className="icon">
                  <a href={`tel:${data.HUSBAND.MOTHER.contact}`} className="tel">
                    <BsTelephoneFill color="#fff" size={20} />
                  </a>
                  <a href={`sms:${data.HUSBAND.MOTHER.contact}`} className="sms">
                    <BsChatText color="#fff" size={20} />
                  </a>
                </div>
              </div>
          ...
          <div className="wife">
            ...
            {data.HUSBAND.FATHER.contact && (
              <div>
                <span>아버지 {data.WIFE.FATHER.name}</span>
                <div className="icon">
                  <a href={`tel:${data.WIFE.FATHER.contact}`} className="tel">
                    <BsTelephoneFill color="#fff" size={20} />
                  </a>
                  <a href={`sms:${data.WIFE.FATHER.contact}`} className="sms">
                    <BsChatText color="#fff" size={20} />
                  </a>
                </div>
              </div>
            ...
            {data.HUSBAND.MOTHER.contact && (
              <div>
                <span>어머니 {data.WIFE.MOTHER.name}</span>
                <div className="icon">
                  <a href={`tel:${data.WIFE.MOTHER.contact}`} className="tel">
                    <BsTelephoneFill color="#fff" size={20} />
                  </a>
                  <a href={`sms:${data.WIFE.MOTHER.contact}`} className="sms">
                    <BsChatText color="#fff" size={20} />
                  </a>
                </div>
              </div>
